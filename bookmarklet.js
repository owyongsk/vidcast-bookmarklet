// From https://github.com/parterburn/vidcast
...
if (!document.getElementById("ovipb336310")) {
    ...
    var pattern = RegExp("(http(s)?)[A-Za-z0-9%?=&:/._-]*[.]{1}(mp4(?!.jpg)|webm|ogg)([?]{1}[A-Za-z0-9%?=&:/.-_;-]*)?", "ig"),
        matches = [],
    ...
    if (-1 != window.location.href.indexOf("khanacademy.org")) {
        var khan_pattern = RegExp("(http(s)?)[A-Za-z0-9%?=&:/._-]*[.]{1}(mp4|webm|ogg)([?/]{1}[A-Za-z0-9%?=&:/.-_;-]*)?(.mp4)",
                "ig"),
